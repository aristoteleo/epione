...
def spectral(
    ...
    if sample_size >= n_sample:
        ...
        console.info("Perform spectral embedding using the Nystrom algorithm...")
        if distance_metric == "cosine":
...
class Spectral:
    ...
    def fit(self, mat, verbose: int = 1):
        ...
        if verbose > 0:
            console.info("Compute similarity matrix")
        ...
        if verbose > 0:
            console.info("Perform decomposition")
